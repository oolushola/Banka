...
router.get('/api/v1/login', userController.getUserLogin);
router.post('/api/v1/auth/login', userController.userLogin);
router.put('/api/v1/profile/:id', userController.updateProfile);
router.get('/api/v1/password-reset', userController.getResetPassword);
router.post('/api/v1/password-reset', userController.resetPassword);
router.post('/api/v1/create-bank-account/:id', userController.createBankAccount);
router.get('/api/v1/user', userController.specificUser);
router.post('/api/v1/change-password/:id', userController.changePassword);
